...
class ArtistData {
  ...
  List<ModelCard> artistData = [
    ...
    ModelCard(
        ...
        "${_counter++}"),
    ModelCard(
        "https://radarbanyumas.disway.id/upload/ad422a48ca6646a6f97bd9bb858c4027.jpg",
        "Queen",
        "993",
        ArtistCardColors().artistCardColors[4],
        "${_counter++}"),
    ModelCard(
        "https://guitar.com/wp-content/uploads/2022/10/Polyphia-Credit-Press-HERO@2560x1625.jpg",
        "Polyphia",
        "536",
        ArtistCardColors().artistCardColors[5],
        "${_counter++}"),
    ModelCard(
        "https://www.rollingstone.com/wp-content/uploads/2023/07/Post-Malone-Album-Review-July-2023.jpg?w=1581&h=1054&crop=1",
        "Post Malone",
        "854",
        ArtistCardColors().artistCardColors[0],
        "${_counter++}",),
